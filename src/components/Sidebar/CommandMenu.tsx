...
const CommandMenu = ({
  ...
  return (
    ...
    >
      <div onClick={(e)=>e.stopPropagation()} className="bg-white rounded-lg shadow-xl border-stone-300 border w-full max-w-lg mx-auto mt-12">
        <Command.Input 
        value={value}
